...
# Fetch historical stock data for BYD (ticker symbol: BYDDF)
ticker = 'BYDDF'
start_date = '2025-01-01'
end_date = '2025-12-01'  # Adjust to a realistic end date
...
print(f"Predicted BYD stock price on {prediction_date.date()}: ${predicted_price_scalar:.2f}")
...
plt.title('BYD Stock Price Prediction using Linear Regression')
plt.legend()
