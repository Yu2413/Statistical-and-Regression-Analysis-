...
# Fetch historical stock data for Palantir Technologies Inc. (PLTR)
ticker = 'PLTR'
start_date = '2024-01-01'
end_date = '2025-03-01'  # Adjusted to a realistic end date
...
print(f"Predicted Palantir Technologies Inc. stock price on {prediction_date.date()}: ${predicted_price_scalar:.2f}")
...
plt.title('Palantir Technologies Inc. Stock Price Prediction using Linear Regression')
plt.legend()
